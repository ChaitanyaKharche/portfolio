  ...
  const handleSend = (e) => {
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          console.log(
            `${error.text} : Message not sent! Try again. (or write to me at <kharche.c@northeastern.edu>)`
          );
          setStatus(false);
      ...
      <form ref={form} className={styles.form} onSubmit={handleSend}>
        ...
        <div className={styles.formElement}>
          ...
          <input
            ...
            id="to"
            className={styles.to}
            placeholder="kharche.c@northeastern.edu"
            disabled
          />
        </div>
        <div className={styles.formElement}>
        ...
        <textarea
          ...
          name="message"
          placeholder={`don't say nasty things like Deez nuts. Be a good son/daughter of your parents. Say "You're hired" instead -- Thank you`}
          required
        ></textarea>
      </form>
